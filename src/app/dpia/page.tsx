  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-emerald-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Avaliação de Impacto sobre a Proteção de Dados (AIPD)</h1>
        <p className="text-sm text-gray-500 mb-8">Art. 35.º do RGPD (Regulamento (UE) 2016/679) — Última atualização: Março 2026</p>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 space-y-8 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">1. Identificação do Projeto</h2>
            <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
              <tbody>
                <tr className="border-b border-gray-100"><td className="py-2 px-3 bg-gray-50 font-medium w-48">Nome do sistema</td><td className="py-2 px-3">SIGA180 — Plataforma de Gestão para Personal Trainers</td></tr>
                <tr className="border-b border-gray-100"><td className="py-2 px-3 bg-gray-50 font-medium">Responsável pelo tratamento</td><td className="py-2 px-3">joaoazuldev (entidade individual) — João Azul</td></tr>
                <tr className="border-b border-gray-100"><td className="py-2 px-3 bg-gray-50 font-medium">Contacto RPD</td><td className="py-2 px-3">rgpd@siga180.pt</td></tr>
                <tr className="border-b border-gray-100"><td className="py-2 px-3 bg-gray-50 font-medium">Data da AIPD</td><td className="py-2 px-3">Março 2026</td></tr>
                <tr><td className="py-2 px-3 bg-gray-50 font-medium">Versão</td><td className="py-2 px-3">1.0</td></tr>
              </tbody>
            </table>
          </section>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">2. Descrição Sistemática do Tratamento</h2>
            ...
            <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
              <thead><tr className="bg-gray-50"><th className="py-2 px-3 text-left">Finalidade</th><th className="py-2 px-3 text-left">Base Legal</th></tr></thead>
              <tbody>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">3. Categorias de Dados Tratados</h2>
            <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
              <thead><tr className="bg-gray-50"><th className="py-2 px-3 text-left">Categoria</th><th className="py-2 px-3 text-left">Dados</th><th className="py-2 px-3 text-left">Sensibilidade</th></tr></thead>
              <tbody>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">4. Avaliação de Necessidade e Proporcionalidade</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">5. Riscos Identificados e Medidas de Mitigação</h2>
            <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
              <thead><tr className="bg-gray-50"><th className="py-2 px-3 text-left">Risco</th><th className="py-2 px-3 text-left">Gravidade</th><th className="py-2 px-3 text-left">Probabilidade</th><th className="py-2 px-3 text-left">Medidas de Mitigação</th></tr></thead>
              <tbody>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">6. Medidas Técnicas e Organizativas (Art. 32.º)</h2>
          ...
          {/* 7. Subprocessadores */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">7. Subprocessadores</h2>
            <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
              <thead><tr className="bg-gray-50"><th className="py-2 px-3 text-left">Subprocessador</th><th className="py-2 px-3 text-left">Função</th><th className="py-2 px-3 text-left">Localização</th><th className="py-2 px-3 text-left">Garantias</th></tr></thead>
              <tbody>
          ...
          {/* 8. Consulta Prévia */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">8. Necessidade de Consulta Prévia (Art. 36.º)</h2>
            <p>
          ...
          {/* 9. Conclusão */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">9. Conclusão e Aprovação</h2>
            <p>
