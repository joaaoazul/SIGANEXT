...
import { generateSecurePassword, normalizeEmail, safePaginationLimit } from "@/lib/security";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const limit = safePaginationLimit(parseInt(searchParams.get("limit") || "100"));
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Password: use provided, or generate a cryptographically secure one
    ...
    logger.exception("Client creation error", error);
