              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 dark:bg-gray-950 border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left px-4 py-3 font-semibold text-gray-900 dark:text-white">Cookie</th>
                    <th className="text-left px-4 py-3 font-semibold text-gray-900 dark:text-white">Finalidade</th>
                    <th className="text-left px-4 py-3 font-semibold text-gray-900 dark:text-white">Duração</th>
                    <th className="text-left px-4 py-3 font-semibold text-gray-900 dark:text-white">Tipo</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400 whitespace-nowrap">7 dias</td>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400 whitespace-nowrap">Indefinido</td>
                    <td className="px-4 py-3">
                      <span className="px-2 py-0.5 bg-blue-50 text-blue-700 text-xs font-medium rounded-full">
                        Essencial
                      </span>
